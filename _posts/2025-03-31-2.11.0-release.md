...
{% include playlink.html link="Download Pachli 2.11.0 from Google Play" app="app.pachli" campaign="release-2.11.0" content="textlink" %}, [F-Droid](https://f-droid.org/en/packages/app.pachli/), or the [GitHub release page](https://github.com/pachli/pachli-android/releases/tag/v2.11.0).